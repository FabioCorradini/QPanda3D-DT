...
class QPanda3DEngineSynchronizer(QTimer):
    def __init__(self, qPanda3DWidget):
        QTimer.__init__(self)
        self.qPanda3DWidget = qPanda3DWidget
        self.setInterval(0)
        self.timeout.connect(self.tick)
...
class QPanda3DWidget(QWidget):
    ...
    def __init__(self, panda3DWorld, parent=None, FPS=20, debug=False):
        ...
        self.eng_sync = QPanda3DEngineSynchronizer(self)
        self.eng_sync.start()
